...
def download_image(url):
    ...
    with open(saveDirectory + file_name, "wb+") as f:
        for data in progress.iterable:
            ...
            try:
                ...
                print("Issue with writing data to the image file.")
    ...
    except Exception as corruptImg_exception:
        print("Unable to open image, possible corrupt image.")
...
def scrape_4chan(start, end, groups, country_code):
    ...
    for group in groups:
        ...
        while current_page != None:
            ...
            #TODO: Decreased the time.sleep from time.sleep(20). time.sleep(10) works but time.sleep(8) is too short. time.sleep(8) works
            time.sleep(9)
            ...
            except Exception as KeyError_exception:
