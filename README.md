...
<br /><br />
This app is a locally-hosted version of the web-tool developed for the [Digital Democracies Institute](https://digitaldemocracies.org/) at Simon Fraser University. This version requires that the user have enough hardware space for all the images that they desire to download and analyze. 
